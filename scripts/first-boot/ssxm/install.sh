...
readonly BACKUP_FILE="/var/triveni/install/backup/ssxm_backup.tar.gz"

readonly ROOT_DIR="/var/triveni/install/first-boot/ssxm"
...
echo "**********************************************************************"
echo "Running install-ssxm.sh (installing SSXM from /var/triveni/install/first-boot/ssxm/ssxm_*.deb if present)"
