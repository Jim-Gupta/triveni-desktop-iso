...
readonly ROOT_DIR="/var/triveni/install/product-scripts/gb"

export DEBIAN_FRONTEND=noninteractive
echo "**********************************************************************"
echo "Running install-gb.sh (installing GB from /var/triveni/install/product-scripts/gb/gb_*.deb if present)"
